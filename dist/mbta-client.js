(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["mbta-client"] = factory();
	else
		root["mbta-client"] = factory();
})(window, function() {
...
const normalizeType = type => {
  ...
  const typeIndex = typeNames.findIndex(name =>
    new RegExp(type, 'i').test(name)
  );
  return typeIndex > -1 ? typeIndex : null;
};
...
//# sourceMappingURL=mbta-client.map