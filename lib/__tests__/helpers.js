...
describe("helper functions", () => {
  ...
  describe("multiple queries", () => {
    ...
    `(
      `handles single or multiple queries: $name`,
      async ({ queryParams, expected }) => {
  ...
  describe("convertTo", () => {
    ...
    it.each([
      ...
      expect(() => convertMs(inputMS, convertTo)).toThrowErrorMatchingInlineSnapshot(
        `"Invalid 'convertTo' value"`
      );
    });
  });
